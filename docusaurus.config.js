...
const config = {
  ...
  projectName: 'angularTutorials', // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/tcarvi/angularTutorials/edit/main/',
        },
        blog: {
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/tcarvi/angularTutorials',
            label: 'GitHub',
            position: 'right',
          },
        ],
